                    ...
                    for await (const sourceFile of sourceFiles) {
                        ...
                        if (sourceFileExists) {
                            ...
                            if (importMatched.titleTag) {
                                exportMarkdownLines.push(`<${importMatched.titleTag}>${escapeMarkdownSpecialCharacters_1.escapeMarkdownSpecialCharacters(path_1.default.relative(markdownFileDirname, sourceFile))}</${importMatched.titleTag}>`);
                            }
